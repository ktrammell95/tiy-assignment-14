...
this["JST"]["photo-albums"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"photo-preview\">\n  <div class=\"photo\">\n    <img width=\"100\" src=\""
    ...
    + "\">\n  </div>\n  <div class=\"info\">\n    <strong>Name:</strong>\n    <span>"
    + escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"name","hash":{},"data":data}) : helper)))
    + "</span>\n  </div>\n  <div class=\"more\">\n    <a href=\"#\" image-detail-id="
    + escapeExpression(((helper = (helper = helpers['image-detail'] || (depth0 != null ? depth0['image-detail'] : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"image-detail","hash":{},"data":data}) : helper)))
    + ">\n    See Image</a>\n  </div>\n</div>";
},"useData":true});
this["JST"] = this["JST"] || {};
this["JST"]["photo-groups"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
